...
router.post('/add', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var products, id, lastProductArray, lastProduct, product;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          if (products.length > 0) {
            lastProductArray = products.slice(-1);
            lastProduct = lastProductArray[0];
            id = lastProduct.id + 1;
          } else {
            id = 1;
          }
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          newCollections = products.slice(-10);
...
router.get('/popular/:category', /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var category, products, popularProducts;
...
router.get('/get/:productId', /*#__PURE__*/function () {
...
router.patch('/update', /*#__PURE__*/function () {
