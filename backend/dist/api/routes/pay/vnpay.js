...
router.post("/create_payment_url", function (req, res, next) {
  ...
  var orderInfo = "Thanh toan hoa don ".concat(orderId, ". Thoi gian: ").concat(moment(date).format("YYYY-MM-DD HH:mm:ss"));
...
router.get("/vnpay_ipn", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var vnp_Params, secureHash, secretKey, signData, hmac, signed, orderId, rspCode, amount, order, total;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          amount = vnp_Params["vnp_Amount"] / 100; // Kiểm tra dữ liệu có hợp lệ không, cập nhật trạng thái đơn hàng và gửi kết quả cho VNPAY theo định dạng dưới
          _context.prev = 13;
          _context.next = 16;
...
router.get("/vnpay_return", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var vnp_Params, response, secureHash, tmnCode, secretKey, signData, hmac, signed, rspCode, amount, transactionNo, transactionStatus, bankCode, cardType, orderInfo;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 13:
          ...
          if (secureHash === signed) {
            ...
            orderInfo = Object.keys(querystring.parse(vnp_Params["vnp_OrderInfo"]));
