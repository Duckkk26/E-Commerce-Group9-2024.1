...
router.get('/get', fetchUser, /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 5;
          return Promise.all(userCart.cart_data.map(/*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    product.colors.forEach(function (colorItem) {
...
router.post('/addToCart', fetchUser, /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var userCart, found, index;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          ...
          found = false;
          index = 0;
          userCart.cart_data.forEach(function (product, i) {
          ...
          if (found) {
            ...
            userCart.cart_data = [].concat(_toConsumableArray(userCart.cart_data), [{
...
router.post('/removeFromCart', fetchUser, /*#__PURE__*/function () {
...
router["delete"]('/deleteFromCart', fetchUser, /*#__PURE__*/function () {
