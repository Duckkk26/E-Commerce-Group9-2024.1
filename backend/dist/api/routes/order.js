      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          orders = orders.map(function (order) {
            ...
            return _objectSpread(_objectSpread({}, order.toObject()), {}, {
              total: total
            });
          });
  ...
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 13:
          _context4.next = 15;
          return Promise.all(orders.map(/*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    total = 0;
                    _context3.next = 3;
                    return Promise.all(order.products.map(/*#__PURE__*/function () {
                        ...
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                              ...
                              return _context2.abrupt("return", _objectSpread(_objectSpread({}, product.toObject()), {}, {
                                name: orderProduct ? orderProduct.name : "Unknown product"
                              }));
                            case 8:
                              _context2.prev = 8;
                              _context2.t0 = _context2["catch"](1);
                              console.error("Error fetching product details:", _context2.t0);
                              return _context2.abrupt("return", _objectSpread(_objectSpread({}, product.toObject()), {}, {
                  ...
                  case 3:
                    ...
                    return _context3.abrupt("return", _objectSpread(_objectSpread({}, order.toObject()), {}, {
        ...
        case 15:
          ...
          res.status(200).json({
            success: 1,
            orders: _toConsumableArray(orders)
          });
          _context4.next = 23;
          break;
        case 19:
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
            ...
            var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(product) {
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 5:
                    orderProduct = _context5.sent;
                    return _context5.abrupt("return", _objectSpread(_objectSpread({}, product.toObject()), {}, {
                      name: orderProduct ? orderProduct.name : "Unknown product"
                    }));
                  case 9:
                    _context5.prev = 9;
        ...
        case 15:
          orderProducts = _context6.sent;
          res.status(200).json({
            success: 1,
            order: _objectSpread(_objectSpread({}, order.toObject()), {}, {
              products: orderProducts,
              old_total: oldTotal,
              total: total
            })
  ...
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
            ...
            var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(product) {
              ...
              return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                while (1) switch (_context7.prev = _context7.next) {
                  ...
                  case 3:
                    orderProduct = _context7.sent;
                    color = orderProduct.colors.find(function (item) {
                      return item.color === product.color;
                    });
                    return _context7.abrupt("return", _objectSpread(_objectSpread({}, product.toObject()), {}, {
                  ...
                  case 8:
                    ...
                    console.error("Error fetching product details:", _context7.t0);
                    return _context7.abrupt("return", _objectSpread(_objectSpread({}, product.toObject()), {}, {
                      new_price: 0,
                      old_price: 0
                    }));
        ...
        case 4:
          newOrder.products = _context8.sent;
          _context8.next = 7;
        ...
        case 10:
          ...
          console.error("Error creating orders:", _context8.t0);
