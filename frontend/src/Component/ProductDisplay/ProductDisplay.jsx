                  ...
                  return (
                    <div
                      ...
                      className={`swiper-slide thumb-img ${
                        index === i ? "swiper-slide-thumb-active" : ""
                      }`}
                      onClick={() => setIndex(i)}
                    >
                ...
                {product.colors.map((item, index) => (
                  <li
                    ...
                    className={`item-color ${
                      choosenColor === index && "choosen-color"
                    }`}
                    onClick={() => {
                  ...
                  >
                    <a title={item.color} className="change-color-btn">
                      ...
                      <div>
                        <strong className="item-color-name">
                          {item.color}
                        </strong>
          ...
          <div className="box-price">
            <div className="item-price-detail">
              <p className="item-new-price">
                {formatPrice(product.colors[choosenColor].new_price)}
              </p>
            </div>
            <div className="item-price-detail">
              <p className="item-old-price">
                {formatPrice(product.colors[choosenColor].old_price)}
              </p>
            </div>
          </div>
