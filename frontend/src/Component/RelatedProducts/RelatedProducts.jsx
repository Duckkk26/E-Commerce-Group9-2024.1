...
function RelatedProducts({ category }) {
  ...
  useEffect(() => {
    if (index < -maxIndex) {
      if (window.innerWidth > 1200) {
        setIndex(
          relatedProducts.length > 5 ? -(relatedProducts.length - 5) : 0
        );
      } else if (window.innerWidth > 990) {
        setIndex(
        ...
        setIndex(
          relatedProducts.length > 3 ? -(relatedProducts.length - 3) : 0
        );
      } else {
        setIndex(
          relatedProducts.length > 2 ? -(relatedProducts.length - 2) : 0
        );
      }
    }
  }, [maxIndex, index]);
